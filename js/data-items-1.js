...
H("hindustani","Hindustani Classical Music","music","north","Uttar Pradesh","Varanasi","images/pool/sitar.jpg",
...
H("awadhi-biryani","Awadhi Biryani","foods","north","Uttar Pradesh","Lucknow","images/pool/biryani.jpg",
...
H("chole-kulcha","Chole Kulcha","foods","north","Punjab","Amritsar","images/pool/chole-kulcha.jpg",
...
H("lohri","Lohri","festivals","north","Punjab","Amritsar","images/pool/lohri.jpg",
...
H("teej","Teej","festivals","north","Rajasthan","Jaipur","images/pool/teej.jpg",
...
H("magh-mela","Magh Mela","festivals","north","Uttar Pradesh","Prayagraj","images/pool/magh-mela.jpg",
...
H("golden-temple","Golden Temple","temples","north","Punjab","Amritsar","images/pool/golden-temple.jpg",
...
H("mandu","Mandu","historical","north","Madhya Pradesh","Dhar","images/pool/taj.jpg",
...
H("chand-baori","Chand Baori","architecture","north","Rajasthan","Ranakpur","images/pool/chand-baori.jpg",
...
H("ranthambore-fort","Ranthambore Fort","forts","north","Rajasthan","Sawai Madhopur","images/pool/ranthambore.jpg",
...
H("miniatures","Rajasthani Miniature Painting","crafts","north","Rajasthan","Jaipur","images/pool/miniatures.jpg",
...
H("gond","Gond Painting","crafts","north","Madhya Pradesh","Rewa","images/pool/gond.jpg",
...
H("bandhani","Bandhani","textiles","north","Rajasthan","Ajmer","images/pool/bandhani.jpg",
...
H("chikankari","Chikankari","textiles","north","Uttar Pradesh","Lucknow","images/pool/chikankari.jpg",
...
H("pashmina","Pashmina Shawls","textiles","north","Jammu & Kashmir","Srinagar","images/pool/pashmina.jpg",
...
H("taj-mahal","Taj Mahal","monuments","north","Uttar Pradesh","Agra","images/pool/taj.jpg",
...
H("qutub-minar","Qutub Minar","monuments","north","Delhi","Delhi","images/pool/qutub.jpg",
...
H("india-gate","India Gate","monuments","north","Delhi","Delhi","images/pool/india-gate-real.jpg",
...
H("dal-lake","Dal Lake","gardens","north","Jammu & Kashmir","Srinagar","images/pool/dal-lake.jpg",
...
H("kathakali","Kathakali","dances","south","Kerala","Thrissur","images/pool/kathakali.jpg",
...
H("carnatic","Carnatic Music","music","south","Tamil Nadu","Madurai","images/pool/veena.jpg",
...
H("hyd-biryani","Hyderabadi Biryani","foods","south","Telangana","Hyderabad","images/pool/biryani.jpg",
...
H("sadya","Kerala Sadya","foods","south","Kerala","Thrissur","images/pool/sadya.jpg",
...
H("dosa","Dosa & Idli","foods","south","Karnataka","Bengaluru","images/pool/masala-dosa.jpg",
...
H("pongal","Pongal","festivals","south","Tamil Nadu","Thanjavur","images/pool/pongal.jpg",
...
H("onam","Onam","festivals","south","Kerala","Thrissur","images/pool/sadya.jpg",
...
H("bathukamma","Bathukamma","festivals","south","Telangana","Warangal","images/pool/bathukamma.jpg",
...
H("brihadeeswarar","Brihadeeswarar Temple","temples","south","Tamil Nadu","Thanjavur","images/pool/brihadeeswarar.jpg",
...
H("meenakshi","Meenakshi Amman Temple","temples","south","Tamil Nadu","Madurai","images/regions/south.jpg",
...
H("mysore-palace","Mysore Palace","forts","south","Karnataka","Mysuru","images/pool/mysore.jpg",
...
H("nataraja","Chola Bronzes (Nataraja)","crafts","south","Tamil Nadu","Thanjavur","images/pool/nataraja.jpg",
...
H("tanjore-painting","Tanjore Painting","crafts","south","Tamil Nadu","Thanjavur","images/pool/tanjore-painting.jpg",
...
H("channapatna","Channapatna Toys","crafts","south","Karnataka","Dharwad","images/pool/channapatna.jpg",
...
H("kanjivaram","Kanjivaram Silk","textiles","south","Tamil Nadu","Kanchipuram","images/pool/kanjivaram.jpg",
...
H("kasavu","Kasavu","textiles","south","Kerala","Kozhikode","images/pool/kasavu.jpg",
...
H("pochampally","Pochampally Saree","textiles","south","Telangana","Warangal","images/pool/pochampally.jpg",
...
H("charminar","Charminar","monuments","south","Telangana","Hyderabad","images/pool/charminar.jpg",
...
H("gol-gumbaz","Gol Gumbaz","monuments","south","Karnataka","Kalaburagi","images/pool/gol-gumbaz.jpg",
...
H("munnar","Munnar Tea Gardens","gardens","south","Kerala","Idukki","images/pool/munnar.jpg",
...
H("alleppey","Alleppey Backwaters","gardens","south","Kerala","Alappuzha","images/pool/alleppey.jpg",
